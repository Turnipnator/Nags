...
3. Also scan `going_detailed` for volatility hedge phrases — *"in places", "watered", "watering", "showers", "becoming softer", "drying out"* — and apply the same demotion if found.
