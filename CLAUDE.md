...
> ⚠ **OPEN, NOT FIXED — 16 of 39 races on 17 Sep logged `field_size=N but N+k runners kept after non-runner filter`.** The kept-runner count exceeds the API's own field size far more often than the one Roscommon case noted on 4 Aug. It matters at the ≤6 boundary of this rule (the larger count makes it fire less, i.e. fail open). Needs its own look.
>
