...
- EXCUSED MOST-RECENT RUN: if the Spotlight gives a specific, race-bound excuse for the LAST run only (wide draw, hampered, wrong ground, missed break, too keen, needed the run), do NOT let that figure suppress the horse — re-read its true level and lift the score. See Hard Rule 18 (Flat C4+ / NH C3+ only; NEVER C5/6)
